                    ...
                    <Carousel.Caption className='d-flex flex-row mb-4  justify-content-between' >
                      {member.social && member.social.facebook &&
                        <div className="px-2 pad-x">
                          <a target='_blank' href={member.social.facebook}> <i className="fab fa-facebook fa-2x"></i> </a>
                        </div>
                      }
                      ...
                      {member.social && member.social.researchGate &&
                        <div className="px-2 pad-x">
                          <a target='_blank' href={member.social.researchGate}> <i className="fab fa-researchgate fa-2x"></i> </a>
                        </div>
                      }
                      {member.social && member.social.github &&
                        <div className="px-2 pad-x">
                          <a target='_blank' href={member.social.github}> <i className="fab fa-github fa-2x"></i> </a>
                        </div>
                      }
                      {member.social && member.social.linkedIn &&
                        <div className="px-2 pad-x">
                          <a target='_blank' href={member.social.linkedIn}> <i className="fab fa-linkedin fa-2x"></i> </a>
                        </div>
                      }
                      {member.social && member.social.web &&
                        <div className="px-2 pad-x">
                          <a target='_blank' href={member.social.web}> <i className="fas fa-globe fa-2x"></i> </a>
                        </div>
                      }
                    </Carousel.Caption>
                  </div>
